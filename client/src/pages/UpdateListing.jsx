    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                <input onChange={handleChange} value={formData.name} className='border p-3 rounded-lg' type="text" id = 'name' placeholder='name' maxLength='62' minLength='10' required/>
                <textarea onChange={handleChange} value={formData.description} className='border p-3 rounded-lg' type="text" id = 'description' placeholder='Description' required/>
                <input onChange={handleChange} value={formData.address} className='border p-3 rounded-lg' type="text" id = 'address' placeholder='Address' required/>
